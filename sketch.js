...
function preload(){
   runnerImg = loadImage("Images/Hero.gif")
  
bg = loadImage("rock.jpg")
  diamondImg = loadImage("me.jpg")
  obstacle1 = loadImage("moralta.png")
  monster1img = loadImage("Images/Monster1.gif")
  monster2img = loadImage("Images/unnamed.gif")
  monster3img = loadImage("Images/Monster3.gif")
  gameoverImg = loadImage("Images/Game.png")
  diamondImg = loadImage("Images/diamond.png")
  
   keyImg = loadImage("Images/Key1.jpg")
